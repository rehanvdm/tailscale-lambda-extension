...
| <code><a href="#tailscale-lambda-extension.TailscaleLambdaExtension.with">with</a></code> | Applies one or more mixins to this construct. |
...
##### `with` <a name="with" id="tailscale-lambda-extension.TailscaleLambdaExtension.with"></a>
...
###### `mixins`<sup>Required</sup> <a name="mixins" id="tailscale-lambda-extension.TailscaleLambdaExtension.with.parameter.mixins"></a>
